...
export interface ApiMovieMovie extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    poster_path: Schema.Attribute.Media<
      'images' | 'files' | 'videos' | 'audios'
    >;
    backdrop_path: Schema.Attribute.Media<
      'images' | 'files' | 'videos' | 'audios'
    >;
    vote_average: Schema.Attribute.Decimal;
    vote_count: Schema.Attribute.Integer;
    runtime: Schema.Attribute.BigInteger;
    statuss: Schema.Attribute.Enumeration<['Released ', 'In Production']>;
    genres: Schema.Attribute.Relation<'manyToMany', 'api::genre.genre'>;
    actors: Schema.Attribute.Relation<'manyToMany', 'api::actor.actor'>;
    providerstreams: Schema.Attribute.Relation<
      'manyToMany',
      'api::providerstream.providerstream'
    >;
...
export interface ApiProviderstreamProviderstream
  extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    type: Schema.Attribute.Enumeration<['tv', 'movie']>;
    movies: Schema.Attribute.Relation<'manyToMany', 'api::movie.movie'>;
    createdAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
    publishedAt: Schema.Attribute.DateTime;
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::providerstream.providerstream': ApiProviderstreamProviderstream;
